// URLs pour Ambulance
export const LOCAL_HOST_AMBULANCE = 'http://172.31.250.20:8081/api/ambulance/';
...
export const LOCAL_HOST_INTERVENTIONS = 'http://172.31.250.20:8081/interventions/';
export const GET_INTERVENTIONS = LOCAL_HOST_INTERVENTIONS + 'recentes';

//export const LOCAL_HOST = 'http://172.31.249.73:8081';

//Table Patients +
export const LOCAL_HOST = 'http://172.31.250.20:8081';
