// URLs pour Ambulance
//export const LOCAL_HOST_AMBULANCE = 'http://172.31.250.7:8081/api/ambulance/';
export const LOCAL_HOST_AMBULANCE = 'http://127.0.0.1:8081/api/ambulance/';
...
export const LOCAL_HOST = 'http://127.0.0.1:8081';
