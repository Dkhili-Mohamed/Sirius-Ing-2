...
export const LOCAL_HOST_AMBULANCE_LOGIN = 'http://172.31.253.112:8081/api/ambulancelogin/';
export const LOGIN_AMBULANCE = LOCAL_HOST_AMBULANCE_LOGIN + 'login';

export const LOCAL_HOST_AMBULANCE_DATA = 'http://172.31.253.112:8081/api/ambulance/';
...
export const GET_PATIENTS = 'http://172.31.253.112:8081/api/patientA/all';
export const GET_INTERVENTIONS = 'http://172.31.253.112:8081/interventions/recentes';
