    ...
    public void calculerTempsTrajet() {
        ...
        for (Ambulance ambulance : ambulances) {
            ...
            if (ambulance.getAmbulancedistance() == null) {
                System.out.println("Distance non calculée pour l'ambulance "+ ambulance.getIdambulance());
                continue;
            }
            ...
            double temps = ambulance.getAmbulancedistance() / ambulance.getVitessemoyambulance();
